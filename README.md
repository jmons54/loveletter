...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/1ftocEJMRW)
...
```sh
npx nx serve love-letter
```

To create a production bundle:

```sh
npx nx build love-letter
```

To see all available targets to run for a project, run:

```sh
npx nx show project love-letter
```
